      ...
      <header className="border-b border-zinc-900 bg-[#070708]/95 backdrop-blur-md px-6 lg:px-12">
        <div className="max-w-[1440px] mx-auto h-20 flex items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-4 md:gap-6 flex-1 justify-end">
            ...
            {/* ÁREA DE AUTENTICAÇÃO (NOME EM CIMA, SAIR EMBAIXO) */}
            {loggedUserName ? (
              <div className="flex flex-col items-end justify-center flex-shrink-0 select-none border-r border-zinc-800 pr-5 h-12 gap-0.5">
                <span className="max-w-36 truncate text-sm font-black tracking-widest text-[#00ff66] uppercase italic">
                  {loggedUserName}
                </span>
                <button 
                  onClick={onLogout} 
                  className="text-[13px] font-mono tracking-widest text-zinc-500 hover:text-red-500 transition-colors uppercase cursor-pointer"
                >
                  [SAIR]
                </button>
              </div>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/xl" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 text-zinc-300 group-hover:text-[#00ff66] group-hover:scale-110 transition-all duration-200">
