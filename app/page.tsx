...
const ALL_PRODUCTS = [
  ...
  { 
    ...
    price: 289.90, 
    priceString: "289,90", 
    image: "https://imgcentauro-a.akamaihd.net/660x660/94910702A3.jpg",
  ...
  { 
    ...
    price: 289.90, 
    priceString: "289,90", 
    image: "https://imgcentauro-a.akamaihd.net/660x660/93476131A2.jpg",
        ...
        <div className="relative group/showcase px-0 md:px-4 select-none">
          ...
          {filteredProducts.length > 2 && (
            <button 
              ...
              className="absolute -left-3 top-1/2 -translate-y-1/2 z-30 w-11 h-11 rounded-full border border-zinc-800 bg-black text-zinc-400 flex items-center justify-center hover:border-[#00ff66] hover:text-[#00ff66] transition-all cursor-pointer shadow-xl"
            >
          ...
          {/* Grade de Exibição Deslizante (2 Cards por vez para maior destaque) */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 overflow-hidden items-center min-h-[220px]">
            {filteredProducts.slice(showcaseIndex, showcaseIndex + 2).map((product) => (
              <div 
                key={product.id} 
                className="bg-[#0f0f11] border border-zinc-900 hover:border-zinc-800 rounded-2xl p-6 flex gap-6 items-center group transition-all duration-300 min-h-[200px] hover:shadow-[0_4px_40px_rgba(0,0,0,0.6)]"
              >
                {/* Foto Miniatura Ampliada (w-40 h-40) */}
          ...
          {filteredProducts.length > 2 && (
            <button 
              ...
              className="absolute -right-3 top-1/2 -translate-y-1/2 z-30 w-11 h-11 rounded-full border border-zinc-800 bg-black text-zinc-400 flex items-center justify-center hover:border-[#00ff66] hover:text-[#00ff66] transition-all cursor-pointer shadow-xl"
            >
